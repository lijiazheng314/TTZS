...
class SimpleQNetwork(Model):
    ...
    def __init__(self, obs_shape, n_actions_team1, n_actions_team2, hidden_dim=64):
        ...
        nn.initializer.Uniform(low=-0.2, high=0.2)(self.fc3.weight)  # 从默认改为±0.2
        nn.initializer.Uniform(low=-0.05, high=0.05)(self.fc3.bias)  # 从默认改为±0.05
...
class DecentralizedFQIAlgorithm:
    ...
    def _compute_agent_loss(self, trajectory_data, targets, agent_id, batch_indices):
        ...
        # 导Team1: team1_actions[自己], team2_actions[0] (对手)
        # 导Team2: team1_actions[自己], team2_actions[自己] (对应Team1对手)
